    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="mt-6">
            ...
            <p class="mt-3 text-sm text-slate-500">
                Von {{ $page->user?->name ?? 'Unbekannt' }} · {{ $page->created_at->format('d.m.Y') }}
            </p>
        </div>
        ...
        @if ($related->isNotEmpty())
            <div class="mt-10">
                <h3 class="text-sm font-semibold uppercase tracking-widest text-slate-500">Weitere Artikel in {{ $page->category }}</h3>
